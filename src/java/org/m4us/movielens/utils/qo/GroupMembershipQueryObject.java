 ...
 * @author arka
 */
public class GroupMembershipQueryObject implements ListQueryObject{
    ...
    public List<DataTransferObject> retrieveList(DataTransferObject object, Connection conn) {
        ...
        StringBuilder queryString = new StringBuilder("select GROUPS.GROUP_ID,GROUPS.GROUP_NAME from FRIENDS,GROUPS ");
        queryString.append("where FRIENDS.GROUP_ID = GROUPS.GROUP_ID and FRIENDS.USER_ID=?");
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(GroupMembershipQueryObject.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        return groupsList;
    }
